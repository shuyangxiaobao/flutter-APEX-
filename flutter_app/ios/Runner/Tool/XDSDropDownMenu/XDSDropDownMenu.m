...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.imageList count] == [self.titleList count]) {
        cell.textLabel.text =[(NSString *)[self.titleList objectAtIndex:indexPath.row] componentsSeparatedByString:@","].firstObject;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.delegate setDropDownDelegate:self title:_titleList[indexPath.row]];
//
//    _titleList[indexPath.row];
